crypt.jsonPCallback.notifications({
  notifications: [
    ...
    },
    {
      ...
      imageClickURL: "",
      content:
        "<div style='font-size: 1.5em; margin-top: 30px;'>Everyone's most important job is to make great decisions. Great decisions will have a bigger impact on long-term outcomes than quantity produced or time spent.</div><span style ='padding-left: 80px; float: right; padding-top: 16px; text-indent: -11px; color: rgba(255, 255, 255, 0.74);'>– Rand Fishkin</span>",
      buttonTextPrimary: "",
      buttonURLPrimary: "",
      buttonTextAlt: "",
      buttonURLAlt: "",
